...
const CheckoutAddressDetailsComponent = () => {
  return (
    <div className='grid grid-cols-10 grid-rows-3 gap-6 text-black'>
      <div className='col-span-3'>
        <input
          type='text'
          placeholder='Name'
          className='w-full bg-white border border-gray-300 rounded-lg pl-2 py-1 placeholder-gray-600' />
      </div>
      ...
      <div className='col-span-6 row-start-2 relative'>
        <input
          type='email'
          placeholder='Email'
          className='w-full bg-white border border-gray-300 rounded-lg pl-8 py-1 placeholder-gray-600' />
